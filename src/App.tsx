...
const DEFAULT_BROLL: BrollPlanSettings = {
  workflowMode: 'cleaned-video', provider: 'gemini', countMode: 'auto', targetCount: 6, imagesPerMinute: 5, intervalSeconds: 20,
