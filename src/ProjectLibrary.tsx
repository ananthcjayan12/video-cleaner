  ...
  return <section className="projectLibrary">
    <div className="libraryHero panel">
      <div>
        ...
        <p>Projects, transcripts, edits, B-roll images and generated clips stay on this computer. The large original video remains referenced in its existing location.</p>
      </div>
